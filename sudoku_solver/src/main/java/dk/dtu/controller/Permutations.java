...
public class Permutations {
    ...
    // Generates 5 individual boards where the corners line up for a samurai sudoku.
    // Returns an array of boards with the following index:
    ...
    public static int[][][] shuffleSamurai(int[][] board) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            tlBottomRightBox[i] = boardTopLeft[i / boxSize + size - boxSize][i - i / boxSize * boxSize + size
                    - boxSize];
    ...
    // Standard shuffle algorithm, calls all functions below to generate a new and
    // unique board
    ...
    // Replaces all numbers in the sudoku with a different number (i.e. all 1 = 5,
    // all 2 = 3, ...)
